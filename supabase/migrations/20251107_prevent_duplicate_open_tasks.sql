-- Enforce single open task per room/day while allowing closed tasks to coexist
...
DROP TRIGGER IF EXISTS prevent_duplicate_open_room_tasks ON public.tasks;
CREATE TRIGGER prevent_duplicate_open_room_tasks
BEFORE INSERT OR UPDATE ON public.tasks
FOR EACH ROW
EXECUTE FUNCTION public.prevent_duplicate_open_room_tasks();
