-- Restore special-room exception: pralnia, śniadania, przerwa śniadaniowa may have
-- multiple open tasks (multiple housekeepers) per day; other rooms remain one per day.
...
BEGIN
  ...
  IF NEW.status <> 'done' THEN
    ...
    IF room_name IS NOT NULL THEN
      ...
      -- pralnia, śniadania, przerwa śniadaniowa (with or without special chars)
